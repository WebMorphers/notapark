...
const navbar = () => {
  ...
  return (
    <div
      id="nav"
      className="flex w-full top-0  sticky z-10 h-max max-w-full rounded-none py-2 px-4 lg:px-8 lg:py-4 justify-between items-center  mx-auto  bg-white      "
    >
      ...
      <ul className="hidden md:flex">
        <li className="p-4">
          <a
            ...
            href="https://www.instagram.com/direct/t/17847188751065713"
            target="-blank"
          >
            Contact Us
          </a>
      ...
      <ul
        className={
          nav
            ? " fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-gradient-to-tl from-slate-300 to-gray-500 ease-in-out duration-500 z-40"
